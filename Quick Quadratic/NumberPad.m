...
//  CustomKeyboard
//
//  Created by David Arrunategui on 2013-01-21.
//  Copyright (c) 2013 David Arrunategui. All rights reserved.
//

#import "NumberPad.h"

const int numberPadShrinkSize = 10;
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        UIView *keyboardBackground = [[UIView alloc] initWithFrame:self.view.frame];
        keyboardBackground.backgroundColor = [UIColor blackColor];
        keyboardBackground.alpha = 0.4;
        
        // Add the UIToolbar to the main view.
        [self.view insertSubview:keyboardBackground atIndex:0];
...
- (IBAction)buttonPressedUp:(UIButton *)sender
{
    ...
    [UIView animateWithDuration:duration animations:^{
        ...
        [sender setBounds:CGRectMake(0, 0, sender.bounds.size.width + numberPadShrinkSize, sender.bounds.size.height + numberPadShrinkSize)];
...
- (IBAction)numberPadDeletePressedDown:(UIButton *)sender {
